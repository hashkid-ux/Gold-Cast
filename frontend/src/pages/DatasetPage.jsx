  ...
  return (
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '120px 24px 80px' }}>
      <div style={{ marginBottom: '48px' }}>
        ...
        <h1 style={{ fontSize: '3rem', fontWeight: '800', marginBottom: '16px' }}>Raw Data Explorer</h1>
      ...
      <div className="glass-panel" style={{ overflow: 'hidden' }}>
        ...
        <div style={{ overflowX: 'auto' }}>
          {loading ? (
            <div style={{ padding: '60px', textAlign: 'center', color: 'var(--muted-foreground)', fontFamily: 'var(--font-mono)' }}>Loading...</div>
          ) : (
